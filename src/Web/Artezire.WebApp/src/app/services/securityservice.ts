...
export class SecurityService {
    ...
    public Authorize() {
        ...
        let authorizationUrl = 'https://localhost:44395/connect/authorize';
        let client_id = 'angular2client';
        let redirect_uri = 'https://localhost:3000';
        let response_type = 'id_token token';
        let scope = 'apis openid';
    ...
    public Logoff() {
        ...
        let authorizationUrl = 'https://localhost:44395/connect/endsession';

        let id_token_hint = this.retrieve('authorizationDataIdToken');
        let post_logout_redirect_uri = 'https://localhost:3000/Unauthorized';
    ...
    private getUserData = (): Observable<string[]> => {
        this.setHeaders();
        return this._http.get('https://localhost:44395/connect/userinfo', {
